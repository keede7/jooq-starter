...
public class HostSummaryByStages extends TableImpl<Record> {
    ...
    @Override
    public HostSummaryByStages as(Table<?> alias) {
        return new HostSummaryByStages(alias.getQualifiedName(), this);
    }
     ...
     */
    @Override
    public HostSummaryByStages rename(Table<?> name) {
        return new HostSummaryByStages(name.getQualifiedName(), null);
    }
}
