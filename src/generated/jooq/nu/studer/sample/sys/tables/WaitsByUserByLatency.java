...
public class WaitsByUserByLatency extends TableImpl<Record> {
    ...
    @Override
    public WaitsByUserByLatency as(Table<?> alias) {
        return new WaitsByUserByLatency(alias.getQualifiedName(), this);
    }
     ...
     */
    @Override
    public WaitsByUserByLatency rename(Table<?> name) {
        return new WaitsByUserByLatency(name.getQualifiedName(), null);
    }
}
