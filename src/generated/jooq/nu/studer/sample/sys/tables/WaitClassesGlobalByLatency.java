...
public class WaitClassesGlobalByLatency extends TableImpl<Record> {
    ...
    @Override
    public WaitClassesGlobalByLatency as(Table<?> alias) {
        return new WaitClassesGlobalByLatency(alias.getQualifiedName(), this);
    }
     ...
     */
    @Override
    public WaitClassesGlobalByLatency rename(Table<?> name) {
        return new WaitClassesGlobalByLatency(name.getQualifiedName(), null);
    }
}
