...
public class IoByThreadByLatency extends TableImpl<Record> {
    ...
    @Override
    public IoByThreadByLatency as(Table<?> alias) {
        return new IoByThreadByLatency(alias.getQualifiedName(), this);
    }
     ...
     */
    @Override
    public IoByThreadByLatency rename(Table<?> name) {
        return new IoByThreadByLatency(name.getQualifiedName(), null);
    }
}
