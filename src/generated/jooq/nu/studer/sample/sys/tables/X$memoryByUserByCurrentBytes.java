...
public class X$memoryByUserByCurrentBytes extends TableImpl<Record> {
    ...
    @Override
    public X$memoryByUserByCurrentBytes as(Table<?> alias) {
        return new X$memoryByUserByCurrentBytes(alias.getQualifiedName(), this);
    }
     ...
     */
    @Override
    public X$memoryByUserByCurrentBytes rename(Table<?> name) {
        return new X$memoryByUserByCurrentBytes(name.getQualifiedName(), null);
    }
}
