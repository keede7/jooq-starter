...
public class LatestFileIo extends TableImpl<Record> {
     ...
     */
    public final TableField<Record, String> THREAD = createField(DSL.name("thread"), SQLDataType.VARCHAR(317), this, "");
     ...
     */
    public final TableField<Record, String> REQUESTED = createField(DSL.name("requested"), SQLDataType.VARCHAR(11), this, "");
    ...
    @Override
    public LatestFileIo as(Table<?> alias) {
        return new LatestFileIo(alias.getQualifiedName(), this);
    }
     ...
     */
    @Override
    public LatestFileIo rename(Table<?> name) {
        return new LatestFileIo(name.getQualifiedName(), null);
    }
}
