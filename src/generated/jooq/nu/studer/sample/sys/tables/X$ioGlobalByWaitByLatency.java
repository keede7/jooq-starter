...
public class X$ioGlobalByWaitByLatency extends TableImpl<Record> {
    ...
    @Override
    public X$ioGlobalByWaitByLatency as(Table<?> alias) {
        return new X$ioGlobalByWaitByLatency(alias.getQualifiedName(), this);
    }
     ...
     */
    @Override
    public X$ioGlobalByWaitByLatency rename(Table<?> name) {
        return new X$ioGlobalByWaitByLatency(name.getQualifiedName(), null);
    }
}
