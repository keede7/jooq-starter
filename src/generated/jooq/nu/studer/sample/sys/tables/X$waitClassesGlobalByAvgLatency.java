...
public class X$waitClassesGlobalByAvgLatency extends TableImpl<Record> {
    ...
    @Override
    public X$waitClassesGlobalByAvgLatency as(Table<?> alias) {
        return new X$waitClassesGlobalByAvgLatency(alias.getQualifiedName(), this);
    }
     ...
     */
    @Override
    public X$waitClassesGlobalByAvgLatency rename(Table<?> name) {
        return new X$waitClassesGlobalByAvgLatency(name.getQualifiedName(), null);
    }
}
