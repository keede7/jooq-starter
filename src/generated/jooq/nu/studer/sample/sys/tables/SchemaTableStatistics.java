...
public class SchemaTableStatistics extends TableImpl<Record> {
    ...
    @Override
    public SchemaTableStatistics as(Table<?> alias) {
        return new SchemaTableStatistics(alias.getQualifiedName(), this);
    }
     ...
     */
    @Override
    public SchemaTableStatistics rename(Table<?> name) {
        return new SchemaTableStatistics(name.getQualifiedName(), null);
    }
}
