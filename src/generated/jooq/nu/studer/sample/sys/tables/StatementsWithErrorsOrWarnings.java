...
public class StatementsWithErrorsOrWarnings extends TableImpl<Record> {
    ...
    @Override
    public StatementsWithErrorsOrWarnings as(Table<?> alias) {
        return new StatementsWithErrorsOrWarnings(alias.getQualifiedName(), this);
    }
     ...
     */
    @Override
    public StatementsWithErrorsOrWarnings rename(Table<?> name) {
        return new StatementsWithErrorsOrWarnings(name.getQualifiedName(), null);
    }
}
