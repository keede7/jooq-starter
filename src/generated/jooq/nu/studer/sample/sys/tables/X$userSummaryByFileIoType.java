...
public class X$userSummaryByFileIoType extends TableImpl<Record> {
    ...
    @Override
    public X$userSummaryByFileIoType as(Table<?> alias) {
        return new X$userSummaryByFileIoType(alias.getQualifiedName(), this);
    }
     ...
     */
    @Override
    public X$userSummaryByFileIoType rename(Table<?> name) {
        return new X$userSummaryByFileIoType(name.getQualifiedName(), null);
    }
}
