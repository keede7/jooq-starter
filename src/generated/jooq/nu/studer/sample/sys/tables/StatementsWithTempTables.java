...
public class StatementsWithTempTables extends TableImpl<Record> {
    ...
    @Override
    public StatementsWithTempTables as(Table<?> alias) {
        return new StatementsWithTempTables(alias.getQualifiedName(), this);
    }
     ...
     */
    @Override
    public StatementsWithTempTables rename(Table<?> name) {
        return new StatementsWithTempTables(name.getQualifiedName(), null);
    }
}
