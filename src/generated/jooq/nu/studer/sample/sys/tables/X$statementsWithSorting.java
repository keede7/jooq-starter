...
public class X$statementsWithSorting extends TableImpl<Record> {
    ...
    @Override
    public X$statementsWithSorting as(Table<?> alias) {
        return new X$statementsWithSorting(alias.getQualifiedName(), this);
    }
     ...
     */
    @Override
    public X$statementsWithSorting rename(Table<?> name) {
        return new X$statementsWithSorting(name.getQualifiedName(), null);
    }
}
