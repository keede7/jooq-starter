...
public class X$statementAnalysis extends TableImpl<Record> {
     ...
     */
    public final TableField<Record, ULong> EXEC_SECONDARY_COUNT = createField(DSL.name("exec_secondary_count"), SQLDataType.BIGINTUNSIGNED.nullable(false), this, "");
     ...
     */
    public final TableField<Record, ULong> CPU_LATENCY = createField(DSL.name("cpu_latency"), SQLDataType.BIGINTUNSIGNED.nullable(false), this, "");
    ...
    @Override
    public X$statementAnalysis as(Table<?> alias) {
        return new X$statementAnalysis(alias.getQualifiedName(), this);
    }
     ...
     */
    @Override
    public X$statementAnalysis rename(Table<?> name) {
        return new X$statementAnalysis(name.getQualifiedName(), null);
    }
}
