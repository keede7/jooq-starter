...
public class X$latestFileIo extends TableImpl<Record> {
    ...
    @Override
    public X$latestFileIo as(Table<?> alias) {
        return new X$latestFileIo(alias.getQualifiedName(), this);
    }
     ...
     */
    @Override
    public X$latestFileIo rename(Table<?> name) {
        return new X$latestFileIo(name.getQualifiedName(), null);
    }
}
