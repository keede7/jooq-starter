...
public class StatementAnalysis extends TableImpl<Record> {
     ...
     */
    public final TableField<Record, String> MAX_CONTROLLED_MEMORY = createField(DSL.name("max_controlled_memory"), SQLDataType.VARCHAR(11), this, "");

    /**
     * The column <code>sys.statement_analysis.max_total_memory</code>.
     */
    public final TableField<Record, String> MAX_TOTAL_MEMORY = createField(DSL.name("max_total_memory"), SQLDataType.VARCHAR(11), this, "");
    ...
    @Override
    public StatementAnalysis as(Table<?> alias) {
        return new StatementAnalysis(alias.getQualifiedName(), this);
    }
     ...
     */
    @Override
    public StatementAnalysis rename(Table<?> name) {
        return new StatementAnalysis(name.getQualifiedName(), null);
    }
}
