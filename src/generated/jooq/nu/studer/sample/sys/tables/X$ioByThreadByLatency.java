...
public class X$ioByThreadByLatency extends TableImpl<Record> {
    ...
    @Override
    public X$ioByThreadByLatency as(Table<?> alias) {
        return new X$ioByThreadByLatency(alias.getQualifiedName(), this);
    }
     ...
     */
    @Override
    public X$ioByThreadByLatency rename(Table<?> name) {
        return new X$ioByThreadByLatency(name.getQualifiedName(), null);
    }
}
