...
public class UserSummary extends TableImpl<Record> {
     ...
     */
    public final TableField<Record, String> STATEMENT_AVG_LATENCY = createField(DSL.name("statement_avg_latency"), SQLDataType.VARCHAR(11), this, "");
     ...
     */
    public final TableField<Record, String> FILE_IO_LATENCY = createField(DSL.name("file_io_latency"), SQLDataType.VARCHAR(11), this, "");
     ...
     */
    public final TableField<Record, String> TOTAL_MEMORY_ALLOCATED = createField(DSL.name("total_memory_allocated"), SQLDataType.VARCHAR(11), this, "");
    ...
    @Override
    public UserSummary as(Table<?> alias) {
        return new UserSummary(alias.getQualifiedName(), this);
    }
     ...
     */
    @Override
    public UserSummary rename(Table<?> name) {
        return new UserSummary(name.getQualifiedName(), null);
    }
}
