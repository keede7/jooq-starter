...
public class X$userSummaryByFileIo extends TableImpl<Record> {
    ...
    @Override
    public X$userSummaryByFileIo as(Table<?> alias) {
        return new X$userSummaryByFileIo(alias.getQualifiedName(), this);
    }
     ...
     */
    @Override
    public X$userSummaryByFileIo rename(Table<?> name) {
        return new X$userSummaryByFileIo(name.getQualifiedName(), null);
    }
}
