...
public class MemoryByUserByCurrentBytes extends TableImpl<Record> {
    ...
    @Override
    public MemoryByUserByCurrentBytes as(Table<?> alias) {
        return new MemoryByUserByCurrentBytes(alias.getQualifiedName(), this);
    }
     ...
     */
    @Override
    public MemoryByUserByCurrentBytes rename(Table<?> name) {
        return new MemoryByUserByCurrentBytes(name.getQualifiedName(), null);
    }
}
