...
public class SchemaTableStatisticsWithBuffer extends TableImpl<Record> {
     ...
     */
    public final TableField<Record, String> FETCH_LATENCY = createField(DSL.name("fetch_latency"), SQLDataType.VARCHAR(11), this, "");
     ...
     */
    public final TableField<Record, String> IO_READ = createField(DSL.name("io_read"), SQLDataType.VARCHAR(11), this, "");

    /**
     * The column
     * <code>sys.schema_table_statistics_with_buffer.io_read_latency</code>.
     */
    public final TableField<Record, String> IO_READ_LATENCY = createField(DSL.name("io_read_latency"), SQLDataType.VARCHAR(11), this, "");
     ...
     */
    public final TableField<Record, String> IO_WRITE = createField(DSL.name("io_write"), SQLDataType.VARCHAR(11), this, "");

    /**
     * The column
     * <code>sys.schema_table_statistics_with_buffer.io_write_latency</code>.
     */
    public final TableField<Record, String> IO_WRITE_LATENCY = createField(DSL.name("io_write_latency"), SQLDataType.VARCHAR(11), this, "");
     ...
     */
    public final TableField<Record, String> IO_MISC_LATENCY = createField(DSL.name("io_misc_latency"), SQLDataType.VARCHAR(11), this, "");

    /**
     * The column
     * <code>sys.schema_table_statistics_with_buffer.innodb_buffer_allocated</code>.
     */
    public final TableField<Record, String> INNODB_BUFFER_ALLOCATED = createField(DSL.name("innodb_buffer_allocated"), SQLDataType.VARCHAR(11), this, "");

    /**
     * The column
     * <code>sys.schema_table_statistics_with_buffer.innodb_buffer_data</code>.
     */
    public final TableField<Record, String> INNODB_BUFFER_DATA = createField(DSL.name("innodb_buffer_data"), SQLDataType.VARCHAR(11), this, "");

    /**
     * The column
     * <code>sys.schema_table_statistics_with_buffer.innodb_buffer_free</code>.
     */
    public final TableField<Record, String> INNODB_BUFFER_FREE = createField(DSL.name("innodb_buffer_free"), SQLDataType.VARCHAR(11), this, "");
    ...
    @Override
    public SchemaTableStatisticsWithBuffer as(Table<?> alias) {
        return new SchemaTableStatisticsWithBuffer(alias.getQualifiedName(), this);
    }
     ...
     */
    @Override
    public SchemaTableStatisticsWithBuffer rename(Table<?> name) {
        return new SchemaTableStatisticsWithBuffer(name.getQualifiedName(), null);
    }
}
