...
public class HostSummaryByFileIo extends TableImpl<Record> {
    ...
    @Override
    public HostSummaryByFileIo as(Table<?> alias) {
        return new HostSummaryByFileIo(alias.getQualifiedName(), this);
    }
     ...
     */
    @Override
    public HostSummaryByFileIo rename(Table<?> name) {
        return new HostSummaryByFileIo(name.getQualifiedName(), null);
    }
}
