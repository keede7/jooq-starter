...
public class X$statementsWithFullTableScans extends TableImpl<Record> {
    ...
    @Override
    public X$statementsWithFullTableScans as(Table<?> alias) {
        return new X$statementsWithFullTableScans(alias.getQualifiedName(), this);
    }
     ...
     */
    @Override
    public X$statementsWithFullTableScans rename(Table<?> name) {
        return new X$statementsWithFullTableScans(name.getQualifiedName(), null);
    }
}
