...
import nu.studer.sample.sys.enums.SessionExecutionEngine;
...
public class Session extends TableImpl<Record> {
     ...
     */
    public final TableField<Record, SessionExecutionEngine> EXECUTION_ENGINE = createField(DSL.name("execution_engine"), SQLDataType.VARCHAR(9).asEnumDataType(nu.studer.sample.sys.enums.SessionExecutionEngine.class), this, "");
