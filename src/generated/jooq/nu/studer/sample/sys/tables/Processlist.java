...
import nu.studer.sample.sys.enums.ProcesslistExecutionEngine;
...
public class Processlist extends TableImpl<Record> {
     ...
     */
    public final TableField<Record, ProcesslistExecutionEngine> EXECUTION_ENGINE = createField(DSL.name("execution_engine"), SQLDataType.VARCHAR(9).asEnumDataType(nu.studer.sample.sys.enums.ProcesslistExecutionEngine.class), this, "");

    /**
     * The column <code>sys.processlist.statement_latency</code>.
     */
    public final TableField<Record, String> STATEMENT_LATENCY = createField(DSL.name("statement_latency"), SQLDataType.VARCHAR(11), this, "");
     ...
     */
    public final TableField<Record, String> LAST_STATEMENT_LATENCY = createField(DSL.name("last_statement_latency"), SQLDataType.VARCHAR(11), this, "");

    /**
     * The column <code>sys.processlist.current_memory</code>.
     */
    public final TableField<Record, String> CURRENT_MEMORY = createField(DSL.name("current_memory"), SQLDataType.VARCHAR(11), this, "");
     ...
     */
    public final TableField<Record, String> LAST_WAIT_LATENCY = createField(DSL.name("last_wait_latency"), SQLDataType.VARCHAR(13), this, "");
     ...
     */
    public final TableField<Record, String> TRX_LATENCY = createField(DSL.name("trx_latency"), SQLDataType.VARCHAR(11), this, "");
