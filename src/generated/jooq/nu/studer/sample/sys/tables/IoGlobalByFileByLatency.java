...
public class IoGlobalByFileByLatency extends TableImpl<Record> {
    ...
    @Override
    public IoGlobalByFileByLatency as(Table<?> alias) {
        return new IoGlobalByFileByLatency(alias.getQualifiedName(), this);
    }
     ...
     */
    @Override
    public IoGlobalByFileByLatency rename(Table<?> name) {
        return new IoGlobalByFileByLatency(name.getQualifiedName(), null);
    }
}
