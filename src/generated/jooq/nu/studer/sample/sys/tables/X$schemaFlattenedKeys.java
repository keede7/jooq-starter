...
public class X$schemaFlattenedKeys extends TableImpl<Record> {
     ...
     */
    public final TableField<Record, Integer> NON_UNIQUE = createField(DSL.name("non_unique"), SQLDataType.INTEGER, this, "");
    ...
    @Override
    public X$schemaFlattenedKeys as(Table<?> alias) {
        return new X$schemaFlattenedKeys(alias.getQualifiedName(), this);
    }
     ...
     */
    @Override
    public X$schemaFlattenedKeys rename(Table<?> name) {
        return new X$schemaFlattenedKeys(name.getQualifiedName(), null);
    }
}
