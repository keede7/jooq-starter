...
public class PsCheckLostInstrumentation extends TableImpl<Record> {
    ...
    @Override
    public PsCheckLostInstrumentation as(Table<?> alias) {
        return new PsCheckLostInstrumentation(alias.getQualifiedName(), this);
    }
     ...
     */
    @Override
    public PsCheckLostInstrumentation rename(Table<?> name) {
        return new PsCheckLostInstrumentation(name.getQualifiedName(), null);
    }
}
