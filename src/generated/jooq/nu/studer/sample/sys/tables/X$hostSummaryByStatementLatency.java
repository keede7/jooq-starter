...
public class X$hostSummaryByStatementLatency extends TableImpl<Record> {
    ...
    @Override
    public X$hostSummaryByStatementLatency as(Table<?> alias) {
        return new X$hostSummaryByStatementLatency(alias.getQualifiedName(), this);
    }
     ...
     */
    @Override
    public X$hostSummaryByStatementLatency rename(Table<?> name) {
        return new X$hostSummaryByStatementLatency(name.getQualifiedName(), null);
    }
}
