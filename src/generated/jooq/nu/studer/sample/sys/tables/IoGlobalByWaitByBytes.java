...
public class IoGlobalByWaitByBytes extends TableImpl<Record> {
     ...
     */
    public final TableField<Record, String> TOTAL_REQUESTED = createField(DSL.name("total_requested"), SQLDataType.VARCHAR(11), this, "");
    ...
    @Override
    public IoGlobalByWaitByBytes as(Table<?> alias) {
        return new IoGlobalByWaitByBytes(alias.getQualifiedName(), this);
    }
     ...
     */
    @Override
    public IoGlobalByWaitByBytes rename(Table<?> name) {
        return new IoGlobalByWaitByBytes(name.getQualifiedName(), null);
    }
}
