...
public class X$userSummaryByStatementType extends TableImpl<Record> {
    ...
    @Override
    public X$userSummaryByStatementType as(Table<?> alias) {
        return new X$userSummaryByStatementType(alias.getQualifiedName(), this);
    }
     ...
     */
    @Override
    public X$userSummaryByStatementType rename(Table<?> name) {
        return new X$userSummaryByStatementType(name.getQualifiedName(), null);
    }
}
