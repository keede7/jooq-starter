...
public class X$userSummaryByStages extends TableImpl<Record> {
    ...
    @Override
    public X$userSummaryByStages as(Table<?> alias) {
        return new X$userSummaryByStages(alias.getQualifiedName(), this);
    }
     ...
     */
    @Override
    public X$userSummaryByStages rename(Table<?> name) {
        return new X$userSummaryByStages(name.getQualifiedName(), null);
    }
}
