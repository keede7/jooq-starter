...
public class X$hostSummaryByStatementType extends TableImpl<Record> {
    ...
    @Override
    public X$hostSummaryByStatementType as(Table<?> alias) {
        return new X$hostSummaryByStatementType(alias.getQualifiedName(), this);
    }
     ...
     */
    @Override
    public X$hostSummaryByStatementType rename(Table<?> name) {
        return new X$hostSummaryByStatementType(name.getQualifiedName(), null);
    }
}
