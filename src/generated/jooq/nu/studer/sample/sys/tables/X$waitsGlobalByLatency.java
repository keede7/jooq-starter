...
public class X$waitsGlobalByLatency extends TableImpl<Record> {
    ...
    @Override
    public X$waitsGlobalByLatency as(Table<?> alias) {
        return new X$waitsGlobalByLatency(alias.getQualifiedName(), this);
    }
     ...
     */
    @Override
    public X$waitsGlobalByLatency rename(Table<?> name) {
        return new X$waitsGlobalByLatency(name.getQualifiedName(), null);
    }
}
