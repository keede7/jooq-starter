...
public class X$hostSummary extends TableImpl<Record> {
    ...
    @Override
    public X$hostSummary as(Table<?> alias) {
        return new X$hostSummary(alias.getQualifiedName(), this);
    }
     ...
     */
    @Override
    public X$hostSummary rename(Table<?> name) {
        return new X$hostSummary(name.getQualifiedName(), null);
    }
}
