...
public class X$statementsWithErrorsOrWarnings extends TableImpl<Record> {
    ...
    @Override
    public X$statementsWithErrorsOrWarnings as(Table<?> alias) {
        return new X$statementsWithErrorsOrWarnings(alias.getQualifiedName(), this);
    }
     ...
     */
    @Override
    public X$statementsWithErrorsOrWarnings rename(Table<?> name) {
        return new X$statementsWithErrorsOrWarnings(name.getQualifiedName(), null);
    }
}
