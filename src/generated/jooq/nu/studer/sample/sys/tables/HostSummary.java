...
public class HostSummary extends TableImpl<Record> {
    ...
    @Override
    public HostSummary as(Table<?> alias) {
        return new HostSummary(alias.getQualifiedName(), this);
    }
     ...
     */
    @Override
    public HostSummary rename(Table<?> name) {
        return new HostSummary(name.getQualifiedName(), null);
    }
}
