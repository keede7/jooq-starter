...
public class X$hostSummaryByFileIoType extends TableImpl<Record> {
    ...
    @Override
    public X$hostSummaryByFileIoType as(Table<?> alias) {
        return new X$hostSummaryByFileIoType(alias.getQualifiedName(), this);
    }
     ...
     */
    @Override
    public X$hostSummaryByFileIoType rename(Table<?> name) {
        return new X$hostSummaryByFileIoType(name.getQualifiedName(), null);
    }
}
