...
public class X$ioGlobalByFileByLatency extends TableImpl<Record> {
    ...
    @Override
    public X$ioGlobalByFileByLatency as(Table<?> alias) {
        return new X$ioGlobalByFileByLatency(alias.getQualifiedName(), this);
    }
     ...
     */
    @Override
    public X$ioGlobalByFileByLatency rename(Table<?> name) {
        return new X$ioGlobalByFileByLatency(name.getQualifiedName(), null);
    }
}
