...
public class TableConstraints extends TableImpl<Record> {
     ...
     */
    public final TableField<Record, String> CONSTRAINT_TYPE = createField(DSL.name("CONSTRAINT_TYPE"), SQLDataType.VARCHAR(1000000000), this, "");
     ...
     */
    public final TableField<Record, String> ENFORCED = createField(DSL.name("ENFORCED"), SQLDataType.VARCHAR(1000000000), this, "");
