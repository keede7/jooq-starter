...
public class SessionState extends TableImpl<Record> {
     ...
     */
    public final TableField<Record, String> STATE_KEY = createField(DSL.name("STATE_KEY"), SQLDataType.VARCHAR(1000000000), this, "");

    /**
     * The column <code>INFORMATION_SCHEMA.SESSION_STATE.STATE_COMMAND</code>.
     */
    public final TableField<Record, String> STATE_COMMAND = createField(DSL.name("STATE_COMMAND"), SQLDataType.VARCHAR(1000000000), this, "");
