...
public class StSpatialReferenceSystems extends TableImpl<Record> {
     ...
     */
    public final TableField<Record, String> SRS_NAME = createField(DSL.name("SRS_NAME"), SQLDataType.VARCHAR(80).nullable(false), this, "");

    /**
     * The column
     * <code>information_schema.ST_SPATIAL_REFERENCE_SYSTEMS.SRS_ID</code>.
     */
    public final TableField<Record, UInteger> SRS_ID = createField(DSL.name("SRS_ID"), SQLDataType.INTEGERUNSIGNED.nullable(false), this, "");

    /**
     * The column
     * <code>information_schema.ST_SPATIAL_REFERENCE_SYSTEMS.ORGANIZATION</code>.
     */
    public final TableField<Record, String> ORGANIZATION = createField(DSL.name("ORGANIZATION"), SQLDataType.VARCHAR(256), this, "");

    /**
     * The column
     * <code>information_schema.ST_SPATIAL_REFERENCE_SYSTEMS.ORGANIZATION_COORDSYS_ID</code>.
     */
    public final TableField<Record, UInteger> ORGANIZATION_COORDSYS_ID = createField(DSL.name("ORGANIZATION_COORDSYS_ID"), SQLDataType.INTEGERUNSIGNED, this, "");

    /**
     * The column
     * <code>information_schema.ST_SPATIAL_REFERENCE_SYSTEMS.DEFINITION</code>.
     */
    public final TableField<Record, String> DEFINITION = createField(DSL.name("DEFINITION"), SQLDataType.VARCHAR(4096).nullable(false), this, "");
    ...
    private StSpatialReferenceSystems(Name alias, Table<Record> aliased) {
        this(alias, aliased, null);
    }

    private StSpatialReferenceSystems(Name alias, Table<Record> aliased, Field<?>[] parameters) {
    ...
    public <O extends Record> StSpatialReferenceSystems(Table<O> child, ForeignKey<O, Record> key) {
