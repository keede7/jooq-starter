...
public class Fields extends TableImpl<Record> {
     ...
     */
    public final TableField<Record, String> ROW_IDENTIFIER = createField(DSL.name("ROW_IDENTIFIER"), SQLDataType.VARCHAR(1000000000), this, "");

    /**
     * The column <code>INFORMATION_SCHEMA.FIELDS.FIELD_NAME</code>.
     */
    public final TableField<Record, String> FIELD_NAME = createField(DSL.name("FIELD_NAME"), SQLDataType.VARCHAR(1000000000), this, "");
    ...
    private Fields(Name alias, Table<Record> aliased) {
        this(alias, aliased, null);
    }

    private Fields(Name alias, Table<Record> aliased, Field<?>[] parameters) {
    ...
    public <O extends Record> Fields(Table<O> child, ForeignKey<O, Record> key) {
