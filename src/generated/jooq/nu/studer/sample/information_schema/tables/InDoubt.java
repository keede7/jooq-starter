...
public class InDoubt extends TableImpl<Record> {
     ...
     */
    public final TableField<Record, String> TRANSACTION_NAME = createField(DSL.name("TRANSACTION_NAME"), SQLDataType.VARCHAR(1000000000), this, "");

    /**
     * The column <code>INFORMATION_SCHEMA.IN_DOUBT.TRANSACTION_STATE</code>.
     */
    public final TableField<Record, String> TRANSACTION_STATE = createField(DSL.name("TRANSACTION_STATE"), SQLDataType.VARCHAR(1000000000), this, "");

    private InDoubt(Name alias, Table<Record> aliased) {
        this(alias, aliased, null);
    }

    private InDoubt(Name alias, Table<Record> aliased, Field<?>[] parameters) {
    ...
    public <O extends Record> InDoubt(Table<O> child, ForeignKey<O, Record> key) {
