...
public class TableConstraintsExtensions extends TableImpl<Record> {
    ...
    private TableConstraintsExtensions(Name alias, Table<Record> aliased) {
        this(alias, aliased, null);
    }

    private TableConstraintsExtensions(Name alias, Table<Record> aliased, Field<?>[] parameters) {
    ...
    public <O extends Record> TableConstraintsExtensions(Table<O> child, ForeignKey<O, Record> key) {
