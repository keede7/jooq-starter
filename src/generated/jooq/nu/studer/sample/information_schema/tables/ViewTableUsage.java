...
public class ViewTableUsage extends TableImpl<Record> {
     ...
     */
    public final TableField<Record, String> VIEW_CATALOG = createField(DSL.name("VIEW_CATALOG"), SQLDataType.VARCHAR(64).nullable(false), this, "");

    /**
     * The column <code>information_schema.VIEW_TABLE_USAGE.VIEW_SCHEMA</code>.
     */
    public final TableField<Record, String> VIEW_SCHEMA = createField(DSL.name("VIEW_SCHEMA"), SQLDataType.VARCHAR(64).nullable(false), this, "");
