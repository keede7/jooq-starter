...
public class QueryStatistics extends TableImpl<Record> {
     ...
     */
    public final TableField<Record, String> SQL_STATEMENT = createField(DSL.name("SQL_STATEMENT"), SQLDataType.VARCHAR(1000000000), this, "");

    /**
     * The column
     * <code>INFORMATION_SCHEMA.QUERY_STATISTICS.EXECUTION_COUNT</code>.
     */
    public final TableField<Record, Integer> EXECUTION_COUNT = createField(DSL.name("EXECUTION_COUNT"), SQLDataType.INTEGER, this, "");

    /**
     * The column
     * <code>INFORMATION_SCHEMA.QUERY_STATISTICS.MIN_EXECUTION_TIME</code>.
     */
    public final TableField<Record, Double> MIN_EXECUTION_TIME = createField(DSL.name("MIN_EXECUTION_TIME"), SQLDataType.DOUBLE, this, "");

    /**
     * The column
     * <code>INFORMATION_SCHEMA.QUERY_STATISTICS.MAX_EXECUTION_TIME</code>.
     */
    public final TableField<Record, Double> MAX_EXECUTION_TIME = createField(DSL.name("MAX_EXECUTION_TIME"), SQLDataType.DOUBLE, this, "");

    /**
     * The column
     * <code>INFORMATION_SCHEMA.QUERY_STATISTICS.CUMULATIVE_EXECUTION_TIME</code>.
     */
    public final TableField<Record, Double> CUMULATIVE_EXECUTION_TIME = createField(DSL.name("CUMULATIVE_EXECUTION_TIME"), SQLDataType.DOUBLE, this, "");

    /**
     * The column
     * <code>INFORMATION_SCHEMA.QUERY_STATISTICS.AVERAGE_EXECUTION_TIME</code>.
     */
    public final TableField<Record, Double> AVERAGE_EXECUTION_TIME = createField(DSL.name("AVERAGE_EXECUTION_TIME"), SQLDataType.DOUBLE, this, "");

    /**
     * The column
     * <code>INFORMATION_SCHEMA.QUERY_STATISTICS.STD_DEV_EXECUTION_TIME</code>.
     */
    public final TableField<Record, Double> STD_DEV_EXECUTION_TIME = createField(DSL.name("STD_DEV_EXECUTION_TIME"), SQLDataType.DOUBLE, this, "");

    /**
     * The column
     * <code>INFORMATION_SCHEMA.QUERY_STATISTICS.MIN_ROW_COUNT</code>.
     */
    public final TableField<Record, Long> MIN_ROW_COUNT = createField(DSL.name("MIN_ROW_COUNT"), SQLDataType.BIGINT, this, "");

    /**
     * The column
     * <code>INFORMATION_SCHEMA.QUERY_STATISTICS.MAX_ROW_COUNT</code>.
     */
    public final TableField<Record, Long> MAX_ROW_COUNT = createField(DSL.name("MAX_ROW_COUNT"), SQLDataType.BIGINT, this, "");

    /**
     * The column
     * <code>INFORMATION_SCHEMA.QUERY_STATISTICS.CUMULATIVE_ROW_COUNT</code>.
     */
    public final TableField<Record, Long> CUMULATIVE_ROW_COUNT = createField(DSL.name("CUMULATIVE_ROW_COUNT"), SQLDataType.BIGINT, this, "");

    /**
     * The column
     * <code>INFORMATION_SCHEMA.QUERY_STATISTICS.AVERAGE_ROW_COUNT</code>.
     */
    public final TableField<Record, Double> AVERAGE_ROW_COUNT = createField(DSL.name("AVERAGE_ROW_COUNT"), SQLDataType.DOUBLE, this, "");

    /**
     * The column
     * <code>INFORMATION_SCHEMA.QUERY_STATISTICS.STD_DEV_ROW_COUNT</code>.
     */
    public final TableField<Record, Double> STD_DEV_ROW_COUNT = createField(DSL.name("STD_DEV_ROW_COUNT"), SQLDataType.DOUBLE, this, "");

    private QueryStatistics(Name alias, Table<Record> aliased) {
        this(alias, aliased, null);
    }

    private QueryStatistics(Name alias, Table<Record> aliased, Field<?>[] parameters) {
    ...
    public <O extends Record> QueryStatistics(Table<O> child, ForeignKey<O, Record> key) {
