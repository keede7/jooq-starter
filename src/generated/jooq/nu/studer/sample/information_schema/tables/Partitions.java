...
public class Partitions extends TableImpl<Record> {
     ...
     */
    public final TableField<Record, UInteger> PARTITION_ORDINAL_POSITION = createField(DSL.name("PARTITION_ORDINAL_POSITION"), SQLDataType.INTEGERUNSIGNED, this, "");

    /**
     * The column
     * <code>information_schema.PARTITIONS.SUBPARTITION_ORDINAL_POSITION</code>.
     */
    public final TableField<Record, UInteger> SUBPARTITION_ORDINAL_POSITION = createField(DSL.name("SUBPARTITION_ORDINAL_POSITION"), SQLDataType.INTEGERUNSIGNED, this, "");

    /**
     * The column <code>information_schema.PARTITIONS.PARTITION_METHOD</code>.
     */
    public final TableField<Record, String> PARTITION_METHOD = createField(DSL.name("PARTITION_METHOD"), SQLDataType.VARCHAR(13), this, "");

    /**
     * The column
     * <code>information_schema.PARTITIONS.SUBPARTITION_METHOD</code>.
     */
    public final TableField<Record, String> SUBPARTITION_METHOD = createField(DSL.name("SUBPARTITION_METHOD"), SQLDataType.VARCHAR(13), this, "");

    /**
     * The column
     * <code>information_schema.PARTITIONS.PARTITION_EXPRESSION</code>.
     */
    public final TableField<Record, String> PARTITION_EXPRESSION = createField(DSL.name("PARTITION_EXPRESSION"), SQLDataType.VARCHAR(2048), this, "");

    /**
     * The column
     * <code>information_schema.PARTITIONS.SUBPARTITION_EXPRESSION</code>.
     */
    public final TableField<Record, String> SUBPARTITION_EXPRESSION = createField(DSL.name("SUBPARTITION_EXPRESSION"), SQLDataType.VARCHAR(2048), this, "");
     ...
     */
    public final TableField<Record, String> PARTITION_COMMENT = createField(DSL.name("PARTITION_COMMENT"), SQLDataType.CLOB.nullable(false), this, "");

    /**
     * The column <code>information_schema.PARTITIONS.NODEGROUP</code>.
     */
    public final TableField<Record, String> NODEGROUP = createField(DSL.name("NODEGROUP"), SQLDataType.VARCHAR(256), this, "");

    /**
     * The column <code>information_schema.PARTITIONS.TABLESPACE_NAME</code>.
     */
    public final TableField<Record, String> TABLESPACE_NAME = createField(DSL.name("TABLESPACE_NAME"), SQLDataType.VARCHAR(268), this, "");
