...
public class Keywords extends TableImpl<Record> {
     ...
     */
    public final TableField<Record, String> WORD = createField(DSL.name("WORD"), SQLDataType.VARCHAR(128), this, "");

    /**
     * The column <code>information_schema.KEYWORDS.RESERVED</code>.
     */
    public final TableField<Record, Integer> RESERVED = createField(DSL.name("RESERVED"), SQLDataType.INTEGER, this, "");

    private Keywords(Name alias, Table<Record> aliased) {
        this(alias, aliased, null);
    }

    private Keywords(Name alias, Table<Record> aliased, Field<?>[] parameters) {
    ...
    public <O extends Record> Keywords(Table<O> child, ForeignKey<O, Record> key) {
