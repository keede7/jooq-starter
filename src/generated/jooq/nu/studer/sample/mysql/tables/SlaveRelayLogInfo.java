...
import nu.studer.sample.mysql.enums.SlaveRelayLogInfoAssignGtidsToAnonymousTransactionsType;
import nu.studer.sample.mysql.enums.SlaveRelayLogInfoRequireTablePrimaryKeyCheck;
...
public class SlaveRelayLogInfo extends TableImpl<Record> {
     ...
     */
    public final TableField<Record, String> RELAY_LOG_NAME = createField(DSL.name("Relay_log_name"), SQLDataType.CLOB, this, "The name of the current relay log file.");

    /**
     * The column <code>mysql.slave_relay_log_info.Relay_log_pos</code>. The
     * relay log position of the last executed event.
     */
    public final TableField<Record, ULong> RELAY_LOG_POS = createField(DSL.name("Relay_log_pos"), SQLDataType.BIGINTUNSIGNED, this, "The relay log position of the last executed event.");
     ...
     * file were read.
     */
    public final TableField<Record, String> MASTER_LOG_NAME = createField(DSL.name("Master_log_name"), SQLDataType.CLOB, this, "The name of the master binary log file from which the events in the relay log file were read.");

    /**
     * The column <code>mysql.slave_relay_log_info.Master_log_pos</code>. The
     * master log position of the last executed event.
     */
    public final TableField<Record, ULong> MASTER_LOG_POS = createField(DSL.name("Master_log_pos"), SQLDataType.BIGINTUNSIGNED, this, "The master log position of the last executed event.");

    /**
     * The column <code>mysql.slave_relay_log_info.Sql_delay</code>. The number
     * of seconds that the slave must lag behind the master.
     */
    public final TableField<Record, Integer> SQL_DELAY = createField(DSL.name("Sql_delay"), SQLDataType.INTEGER, this, "The number of seconds that the slave must lag behind the master.");

    /**
     * The column <code>mysql.slave_relay_log_info.Number_of_workers</code>.
     */
    public final TableField<Record, UInteger> NUMBER_OF_WORKERS = createField(DSL.name("Number_of_workers"), SQLDataType.INTEGERUNSIGNED, this, "");

    /**
     * The column <code>mysql.slave_relay_log_info.Id</code>. Internal Id that
     * uniquely identifies this record.
     */
    public final TableField<Record, UInteger> ID = createField(DSL.name("Id"), SQLDataType.INTEGERUNSIGNED, this, "Internal Id that uniquely identifies this record.");
     ...
     */
    public final TableField<Record, String> PRIVILEGE_CHECKS_USERNAME = createField(DSL.name("Privilege_checks_username"), SQLDataType.VARCHAR(32), this, "Username part of PRIVILEGE_CHECKS_USER.");
     ...
     */
    public final TableField<Record, String> PRIVILEGE_CHECKS_HOSTNAME = createField(DSL.name("Privilege_checks_hostname"), SQLDataType.VARCHAR(255), this, "Hostname part of PRIVILEGE_CHECKS_USER.");
     ...
     */
    public final TableField<Record, Byte> REQUIRE_ROW_FORMAT = createField(DSL.name("Require_row_format"), SQLDataType.TINYINT.nullable(false), this, "Indicates whether the channel shall only accept row based events.");
     ...
     */
    public final TableField<Record, SlaveRelayLogInfoRequireTablePrimaryKeyCheck> REQUIRE_TABLE_PRIMARY_KEY_CHECK = createField(DSL.name("Require_table_primary_key_check"), SQLDataType.VARCHAR(8).nullable(false).defaultValue(DSL.inline("STREAM", SQLDataType.VARCHAR)).asEnumDataType(nu.studer.sample.mysql.enums.SlaveRelayLogInfoRequireTablePrimaryKeyCheck.class), this, "Indicates what is the channel policy regarding tables without primary keys on create and alter table queries");
     ...
     */
    public final TableField<Record, SlaveRelayLogInfoAssignGtidsToAnonymousTransactionsType> ASSIGN_GTIDS_TO_ANONYMOUS_TRANSACTIONS_TYPE = createField(DSL.name("Assign_gtids_to_anonymous_transactions_type"), SQLDataType.VARCHAR(5).nullable(false).defaultValue(DSL.inline("OFF", SQLDataType.VARCHAR)).asEnumDataType(nu.studer.sample.mysql.enums.SlaveRelayLogInfoAssignGtidsToAnonymousTransactionsType.class), this, "Indicates whether the channel will generate a new GTID for anonymous transactions. OFF means that anonymous transactions will remain anonymous. LOCAL means that anonymous transactions will be assigned a newly generated GTID based on server_uuid. UUID indicates that anonymous transactions will be assigned a newly generated GTID based on Assign_gtids_to_anonymous_transactions_value");
