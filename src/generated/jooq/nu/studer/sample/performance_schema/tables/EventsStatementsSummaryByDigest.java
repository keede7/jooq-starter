...
public class EventsStatementsSummaryByDigest extends TableImpl<Record> {
     ...
     */
    public final TableField<Record, ULong> QUANTILE_95 = createField(DSL.name("QUANTILE_95"), SQLDataType.BIGINTUNSIGNED.nullable(false), this, "");

    /**
     * The column
     * <code>performance_schema.events_statements_summary_by_digest.QUANTILE_99</code>.
     */
    public final TableField<Record, ULong> QUANTILE_99 = createField(DSL.name("QUANTILE_99"), SQLDataType.BIGINTUNSIGNED.nullable(false), this, "");

    /**
     * The column
     * <code>performance_schema.events_statements_summary_by_digest.QUANTILE_999</code>.
     */
    public final TableField<Record, ULong> QUANTILE_999 = createField(DSL.name("QUANTILE_999"), SQLDataType.BIGINTUNSIGNED.nullable(false), this, "");

    /**
     * The column
     * <code>performance_schema.events_statements_summary_by_digest.QUERY_SAMPLE_TEXT</code>.
     */
    public final TableField<Record, String> QUERY_SAMPLE_TEXT = createField(DSL.name("QUERY_SAMPLE_TEXT"), SQLDataType.CLOB, this, "");

    /**
     * The column
     * <code>performance_schema.events_statements_summary_by_digest.QUERY_SAMPLE_SEEN</code>.
     */
    public final TableField<Record, LocalDateTime> QUERY_SAMPLE_SEEN = createField(DSL.name("QUERY_SAMPLE_SEEN"), SQLDataType.LOCALDATETIME(6).nullable(false), this, "");

    /**
     * The column
     * <code>performance_schema.events_statements_summary_by_digest.QUERY_SAMPLE_TIMER_WAIT</code>.
     */
    public final TableField<Record, ULong> QUERY_SAMPLE_TIMER_WAIT = createField(DSL.name("QUERY_SAMPLE_TIMER_WAIT"), SQLDataType.BIGINTUNSIGNED.nullable(false), this, "");
