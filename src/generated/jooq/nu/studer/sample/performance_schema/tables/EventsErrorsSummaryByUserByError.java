...
public class EventsErrorsSummaryByUserByError extends TableImpl<Record> {
    ...
    private EventsErrorsSummaryByUserByError(Name alias, Table<Record> aliased) {
        this(alias, aliased, null);
    }

    private EventsErrorsSummaryByUserByError(Name alias, Table<Record> aliased, Field<?>[] parameters) {
    ...
    public <O extends Record> EventsErrorsSummaryByUserByError(Table<O> child, ForeignKey<O, Record> key) {
