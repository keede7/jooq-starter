...
public class EventsStatementsSummaryByProgram extends TableImpl<Record> {
     ...
     */
    public final TableField<Record, EventsStatementsSummaryByProgramObjectType> OBJECT_TYPE = createField(DSL.name("OBJECT_TYPE"), SQLDataType.VARCHAR(9).nullable(false).asEnumDataType(nu.studer.sample.performance_schema.enums.EventsStatementsSummaryByProgramObjectType.class), this, "");
