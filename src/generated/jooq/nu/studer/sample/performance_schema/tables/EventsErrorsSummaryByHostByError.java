...
public class EventsErrorsSummaryByHostByError extends TableImpl<Record> {
    ...
    private EventsErrorsSummaryByHostByError(Name alias, Table<Record> aliased) {
        this(alias, aliased, null);
    }

    private EventsErrorsSummaryByHostByError(Name alias, Table<Record> aliased, Field<?>[] parameters) {
    ...
    public <O extends Record> EventsErrorsSummaryByHostByError(Table<O> child, ForeignKey<O, Record> key) {
