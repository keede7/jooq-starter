...
public class ReplicationApplierStatusByWorker extends TableImpl<Record> {
     ...
     */
    public final TableField<Record, String> LAST_APPLIED_TRANSACTION = createField(DSL.name("LAST_APPLIED_TRANSACTION"), SQLDataType.CHAR(57), this, "");

    /**
     * The column
     * <code>performance_schema.replication_applier_status_by_worker.LAST_APPLIED_TRANSACTION_ORIGINAL_COMMIT_TIMESTAMP</code>.
     */
    public final TableField<Record, LocalDateTime> LAST_APPLIED_TRANSACTION_ORIGINAL_COMMIT_TIMESTAMP = createField(DSL.name("LAST_APPLIED_TRANSACTION_ORIGINAL_COMMIT_TIMESTAMP"), SQLDataType.LOCALDATETIME(6).nullable(false), this, "");

    /**
     * The column
     * <code>performance_schema.replication_applier_status_by_worker.LAST_APPLIED_TRANSACTION_IMMEDIATE_COMMIT_TIMESTAMP</code>.
     */
    public final TableField<Record, LocalDateTime> LAST_APPLIED_TRANSACTION_IMMEDIATE_COMMIT_TIMESTAMP = createField(DSL.name("LAST_APPLIED_TRANSACTION_IMMEDIATE_COMMIT_TIMESTAMP"), SQLDataType.LOCALDATETIME(6).nullable(false), this, "");

    /**
     * The column
     * <code>performance_schema.replication_applier_status_by_worker.LAST_APPLIED_TRANSACTION_START_APPLY_TIMESTAMP</code>.
     */
    public final TableField<Record, LocalDateTime> LAST_APPLIED_TRANSACTION_START_APPLY_TIMESTAMP = createField(DSL.name("LAST_APPLIED_TRANSACTION_START_APPLY_TIMESTAMP"), SQLDataType.LOCALDATETIME(6).nullable(false), this, "");

    /**
     * The column
     * <code>performance_schema.replication_applier_status_by_worker.LAST_APPLIED_TRANSACTION_END_APPLY_TIMESTAMP</code>.
     */
    public final TableField<Record, LocalDateTime> LAST_APPLIED_TRANSACTION_END_APPLY_TIMESTAMP = createField(DSL.name("LAST_APPLIED_TRANSACTION_END_APPLY_TIMESTAMP"), SQLDataType.LOCALDATETIME(6).nullable(false), this, "");

    /**
     * The column
     * <code>performance_schema.replication_applier_status_by_worker.APPLYING_TRANSACTION</code>.
     */
    public final TableField<Record, String> APPLYING_TRANSACTION = createField(DSL.name("APPLYING_TRANSACTION"), SQLDataType.CHAR(57), this, "");

    /**
     * The column
     * <code>performance_schema.replication_applier_status_by_worker.APPLYING_TRANSACTION_ORIGINAL_COMMIT_TIMESTAMP</code>.
     */
    public final TableField<Record, LocalDateTime> APPLYING_TRANSACTION_ORIGINAL_COMMIT_TIMESTAMP = createField(DSL.name("APPLYING_TRANSACTION_ORIGINAL_COMMIT_TIMESTAMP"), SQLDataType.LOCALDATETIME(6).nullable(false), this, "");

    /**
     * The column
     * <code>performance_schema.replication_applier_status_by_worker.APPLYING_TRANSACTION_IMMEDIATE_COMMIT_TIMESTAMP</code>.
     */
    public final TableField<Record, LocalDateTime> APPLYING_TRANSACTION_IMMEDIATE_COMMIT_TIMESTAMP = createField(DSL.name("APPLYING_TRANSACTION_IMMEDIATE_COMMIT_TIMESTAMP"), SQLDataType.LOCALDATETIME(6).nullable(false), this, "");

    /**
     * The column
     * <code>performance_schema.replication_applier_status_by_worker.APPLYING_TRANSACTION_START_APPLY_TIMESTAMP</code>.
     */
    public final TableField<Record, LocalDateTime> APPLYING_TRANSACTION_START_APPLY_TIMESTAMP = createField(DSL.name("APPLYING_TRANSACTION_START_APPLY_TIMESTAMP"), SQLDataType.LOCALDATETIME(6).nullable(false), this, "");

    /**
     * The column
     * <code>performance_schema.replication_applier_status_by_worker.LAST_APPLIED_TRANSACTION_RETRIES_COUNT</code>.
     */
    public final TableField<Record, ULong> LAST_APPLIED_TRANSACTION_RETRIES_COUNT = createField(DSL.name("LAST_APPLIED_TRANSACTION_RETRIES_COUNT"), SQLDataType.BIGINTUNSIGNED.nullable(false), this, "");

    /**
     * The column
     * <code>performance_schema.replication_applier_status_by_worker.LAST_APPLIED_TRANSACTION_LAST_TRANSIENT_ERROR_NUMBER</code>.
     */
    public final TableField<Record, Integer> LAST_APPLIED_TRANSACTION_LAST_TRANSIENT_ERROR_NUMBER = createField(DSL.name("LAST_APPLIED_TRANSACTION_LAST_TRANSIENT_ERROR_NUMBER"), SQLDataType.INTEGER.nullable(false), this, "");

    /**
     * The column
     * <code>performance_schema.replication_applier_status_by_worker.LAST_APPLIED_TRANSACTION_LAST_TRANSIENT_ERROR_MESSAGE</code>.
     */
    public final TableField<Record, String> LAST_APPLIED_TRANSACTION_LAST_TRANSIENT_ERROR_MESSAGE = createField(DSL.name("LAST_APPLIED_TRANSACTION_LAST_TRANSIENT_ERROR_MESSAGE"), SQLDataType.VARCHAR(1024), this, "");
     ...
     */
    public final TableField<Record, LocalDateTime> LAST_APPLIED_TRANSACTION_LAST_TRANSIENT_ERROR_TIMESTAMP = createField(DSL.name("LAST_APPLIED_TRANSACTION_LAST_TRANSIENT_ERROR_TIMESTAMP"), SQLDataType.LOCALDATETIME(6).nullable(false), this, "");

    /**
     * The column
     * <code>performance_schema.replication_applier_status_by_worker.APPLYING_TRANSACTION_RETRIES_COUNT</code>.
     */
    public final TableField<Record, ULong> APPLYING_TRANSACTION_RETRIES_COUNT = createField(DSL.name("APPLYING_TRANSACTION_RETRIES_COUNT"), SQLDataType.BIGINTUNSIGNED.nullable(false), this, "");

    /**
     * The column
     * <code>performance_schema.replication_applier_status_by_worker.APPLYING_TRANSACTION_LAST_TRANSIENT_ERROR_NUMBER</code>.
     */
    public final TableField<Record, Integer> APPLYING_TRANSACTION_LAST_TRANSIENT_ERROR_NUMBER = createField(DSL.name("APPLYING_TRANSACTION_LAST_TRANSIENT_ERROR_NUMBER"), SQLDataType.INTEGER.nullable(false), this, "");

    /**
     * The column
     * <code>performance_schema.replication_applier_status_by_worker.APPLYING_TRANSACTION_LAST_TRANSIENT_ERROR_MESSAGE</code>.
     */
    public final TableField<Record, String> APPLYING_TRANSACTION_LAST_TRANSIENT_ERROR_MESSAGE = createField(DSL.name("APPLYING_TRANSACTION_LAST_TRANSIENT_ERROR_MESSAGE"), SQLDataType.VARCHAR(1024), this, "");

    /**
     * The column
     * <code>performance_schema.replication_applier_status_by_worker.APPLYING_TRANSACTION_LAST_TRANSIENT_ERROR_TIMESTAMP</code>.
     */
    public final TableField<Record, LocalDateTime> APPLYING_TRANSACTION_LAST_TRANSIENT_ERROR_TIMESTAMP = createField(DSL.name("APPLYING_TRANSACTION_LAST_TRANSIENT_ERROR_TIMESTAMP"), SQLDataType.LOCALDATETIME(6).nullable(false), this, "");
