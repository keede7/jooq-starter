...
public class EventsStatementsHistogramByDigest extends TableImpl<Record> {
    ...
    private EventsStatementsHistogramByDigest(Name alias, Table<Record> aliased) {
        this(alias, aliased, null);
    }

    private EventsStatementsHistogramByDigest(Name alias, Table<Record> aliased, Field<?>[] parameters) {
    ...
    public <O extends Record> EventsStatementsHistogramByDigest(Table<O> child, ForeignKey<O, Record> key) {
